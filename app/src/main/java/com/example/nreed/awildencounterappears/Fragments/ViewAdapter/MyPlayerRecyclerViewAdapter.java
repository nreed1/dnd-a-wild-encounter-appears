...
import com.example.nreed.awildencounterappears.Fragments.PlayerListFragment.OnListFragmentInteractionListener;
...
public class MyPlayerRecyclerViewAdapter extends RecyclerView.Adapter<MyPlayerRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPlayerRecyclerViewAdapter(List<PlayerCharacter> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).getCharacterName());
